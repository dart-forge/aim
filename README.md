<div align="center">
  <img src="docs/public/banner.png" alt="Aim – A lightweight, modular web framework for Dart" width="1536">
</div>
...
- **Web Server** - Lightweight HTTP server with routing and middleware
...
| [aim_workers](./packages/aim_workers) | [![Pub Version](https://img.shields.io/pub/v/aim_workers)](https://pub.dev/packages/aim_workers) | Cloudflare workerd adapter: runs an Aim app as a Worker |
| [aim_deno](./packages/aim_deno) | [![Pub Version](https://img.shields.io/pub/v/aim_deno)](https://pub.dev/packages/aim_deno) | Deno adapter: runs an Aim app on Supabase Edge Functions and other Deno runtimes |
| [aim_functions](./packages/aim_functions) | [![Pub Version](https://img.shields.io/pub/v/aim_functions)](https://pub.dev/packages/aim_functions) | Cloud Functions for Firebase adapter: runs an Aim app as an HTTP function (experimental) |
...
[aim_sqlite](./packages/aim_sqlite) is also in this repository and documented, but has `publish_to: none` and is not yet on pub.dev.
