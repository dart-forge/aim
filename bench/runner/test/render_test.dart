...
void main() {
  final results = BenchResults(
    ...
    settings: {'durationSeconds': 10, 'connections': 64, 'runs': 5, 'oha': 'oha 1.16.0'},
    apps: [
      AppResult(
        name: 'dart_io',
        versions: const {},
        ...
        scenarios: [
          ScenarioResult.fromRuns('plaintext', [
            const OhaResult(requestsPerSec: 123456.7, p50Ms: 0.51, p99Ms: 1.234, successRate: 1, statusCodes: {'200': 1}),
          ]),
        ],
      ),
    ],
